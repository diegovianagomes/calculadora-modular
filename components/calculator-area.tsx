...
const handleSubmit = (e: React.FormEvent) => {
  ...
  return (
    <TooltipProvider>
		...
		<p className="font-sans text-xs text-purple-500">Insira a área total em metros quadrados, o módulo base e uma proporção desejada(Por padrão deixamos a proporção aurea 1.618) para encontrar combinações modulares que se ajustem às dimensões exatas, minimizando desperdícios e otimizando o layout.</p>
